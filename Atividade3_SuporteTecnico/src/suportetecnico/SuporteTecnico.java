...
public class SuporteTecnico {
    ...
    public void inicializar() {
        // Inicializa o banco de soluções e a resposta padrão
        bancoSolucao.put("windows travando", "Este é um problema do sistema operacional Windows. Por favor, entre em contato com a Microsoft. Não há nada que possamos fazer neste caso.");
    ...
    public String buscarSolucao(String problema) {
        String solucao = bancoSolucao.get(problema);
        if (solucao != null) {
            return solucao;
        } else {
